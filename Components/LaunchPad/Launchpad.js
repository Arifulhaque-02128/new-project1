        ...
        <div>
            ...
            <div className={styles.container} >
                <div className={styles.textContainer} style={{textAlign: "left"}}>
                    ...
                    <button className={styles.btn}> Read More <AiOutlineRightCircle style={{marginLeft: "0.1rem"}} size={20}/> </button>
                </div>
                <div className={styles.imgContainer} style={{marginLeft: "5rem"}}>
                    <img src="/launchpad/heroImg1.svg" alt="" />
                </div>
            </div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.imgContainer} style={{marginRight: "5rem"}}>
                    <img src="/launchpad/heroImg2.svg" alt="" />
                </div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.imgContainer} style={{marginLeft: "5rem"}}>
                    <img src="/launchpad/heroImg4.svg" alt="" />
                </div>
            </div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.imgContainer} style={{marginRight: "5rem"}}>
                    <img src="/launchpad/heroImg5.svg" alt="" />
                </div>
            ...
            {/* component - WE ENSURE YOUR BUSINESS & INVESTMENTS ARE */}
            ...
            {/* component - SME WE SERVE */}
            <div className={styles.smeContainer}>
                <h3> SME WE SERVE  </h3>
                <div>
                    <div className={styles.smeImg}>
                        <img src="/launchpad/person1.svg" alt="" />
                        <button className={styles.btn}> Read More <AiOutlineRightCircle style={{marginLeft: "0.1rem"}} size={20}/> </button>
                    </div>
                    <div className={styles.smeImg}>
                        <img src="/launchpad/person2.svg" alt="" />
                        <button className={styles.btn}> Read More <AiOutlineRightCircle style={{marginLeft: "0.1rem"}} size={20}/> </button>
                    </div>
                    <div className={styles.smeImg}>
                        <img src="/launchpad/person3.svg" alt="" />
                        <button className={styles.btn}> Read More <AiOutlineRightCircle style={{marginLeft: "0.1rem"}} size={20}/> </button>
                    </div>
                    <div className={styles.smeImg}>
                        <img src="/launchpad/person4.svg" alt="" />
                        <button className={styles.btn}> Read More <AiOutlineRightCircle style={{marginLeft: "0.1rem"}} size={20}/> </button>
                    </div>
                </div>
            </div>
